...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        call_command("loaddata", "Course.yaml")
        call_command("loaddata", "Field.yaml")
        call_command("loaddata", "Group.yaml")
        call_command("loaddata", "Institution.yaml")
        call_command("loaddata", "Subject.yaml")
