...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('core_subject', 'code', self.gf('django.db.models.fields.IntegerField')(default='xxxx'), keep_default=False)
    ...
    models = {
        ...
        'core.subject': {
            ...
            'subjectcode': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
